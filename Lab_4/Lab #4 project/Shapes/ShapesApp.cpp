...
void ShapesApp::BuildShapeGeometry()
{
	...
	GeometryGenerator::MeshData diamond = geoGen.CreateDiamond(3); /////////////////////////
...
void ShapesApp::BuildRenderItems()
{
	...
	XMStoreFloat4x4(&diamondRitem->World, XMMatrixScaling(2.0f, 2.0f, 2.0f)*XMMatrixTranslation(0.0f, 1.0f, 0.0f));
